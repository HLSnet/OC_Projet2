...
public class Heme_Biotech_Application {
	...
	public static void main(String args[]) throws Exception {
		...
		// Instantiation of an object from AnalyticsCounter
		AnalyticsCounter analyticsCounter = new AnalyticsCounter("symptoms.txt", "result.out");

		// Specify which type of input file
		// in this case, using the implementation ReadSymptomDataFromFile (to read from
		// a text file)
		...
		// in this case, using the implementation CountAllSymptoms (to count the
		// occurrence of ALL the symptoms )
		analyticsCounter.setISymptomCounter(new CountAllSymptoms());

		// Specify which type of output file
		// in this case, using the implementation WriteSymptomDataToFile ( to write a
		// sorted collection in a text file )
