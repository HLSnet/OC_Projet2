...
public class WriteSymptomDataCountedSortedToFile implements ISymptomWriter{
	...
	/**
	 * 
	 * @param filepath  <String> a full or partial path to a writing file with symptom + occurrence strings , one per line
	 */
	public WriteSymptomDataCountedSortedToFile (String filepath) {
		this.filepath = filepath;
	}
	/**
	 *  the object parameter transmitted is casted into a sorted collection
	 *  in order to be written into the output file
	 */
	@Override
